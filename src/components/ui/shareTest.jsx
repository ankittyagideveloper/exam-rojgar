...
export const ShareTest = ({ testTitle, testUrl }) => {
    const shareText = `Attempt the test "${testTitle}" on www.examrojgar.com !\n\n🚆 Test your preparation and improve your score.`;
