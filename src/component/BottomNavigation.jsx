...
const BottomNavigation = () => {
  ...
  const navItems = [
    ...
    { id: "mentor", label: t("mentorBtn"), icon: Target, path: "/target-series" },
    // {
    //   id: "purchase",
    //   label: "My Purchase",
    //   icon: ShoppingBag,
  ...
  return (
    <>
      <nav className="block lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t px-4 py-2 dark:bg-[#121212]">
