  ...
  return (
    <>
      <div className="min-h-screen bg-background">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-1/2 focus:-translate-x-1/2 focus:z-[9999] focus:px-4 focus:py-2 focus:rounded-lg focus:bg-[#1272BA] focus:text-white focus:text-sm focus:font-semibold focus:shadow-lg focus:outline-none safe-top"
        >
